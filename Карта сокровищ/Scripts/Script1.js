...
const GANG = {
		...
		speech:95,
		money:100,
		desc:'Вас окружила целая банда. Человек 20 мускулистых негров с огромными мечами.',
...
function Death(){
	alert('Вы погибли! Вот так - бесславно и глупо закончилось ваше приключение. Ваши останки разорвут дикие животные, ваше имя так и останется никому не известным, а ваша жена будет спать с вашим соседом.');
	a1=0;
	a2=0;
	a3=0;
	a4=0;
